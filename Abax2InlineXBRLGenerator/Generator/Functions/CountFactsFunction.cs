...
/// </summary>
public class CountFactsFunction : ITemplateFunction
{
    ...
    public CountFactsFunction(XbrlFactFinder factFinder, TemplateContext context)
    {
